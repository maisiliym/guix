  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "0km73zhhfjc0rhp5hc8ldpsrzbc00hp4lqwnxz2512qbpsby6bwx"))))
    (build-system glib-or-gtk-build-system)
    (arguments
     '(#:configure-flags
...
(define-public libgnome-games-support
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0gs1k88wwafn5cdyb5yq1cxpi9azachb0ysxgwh15sx77g6plyy3"))))
    (build-system gnu-build-system)
    (arguments
     '(#:phases
       (modify-phases %standard-phases
...
(define-public gnome-session
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0rrxjk3vbqy3cdgnl7rw71dvcyrvhwq3m6s53dnkyjxsrnr0xk3v"))))
    (arguments
     '(#:glib-or-gtk? #t
       #:phases
       (modify-phases %standard-phases
...
(define-public tracker-miners
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "13l9db1511hf6ysr5pgm1yj3c4xwqpc43l1p7mpp9xsj3p3zpkhk"))))
    (build-system meson-build-system)
    (arguments
     `(#:glib-or-gtk? #t
       #:configure-flags
...
(define-public gnome-shell-extensions
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "15hak4prx2nx1svfii39clxy1lll8crdf7p91if85jcsh6r8ab8p"))))
    (build-system meson-build-system)
    (arguments
